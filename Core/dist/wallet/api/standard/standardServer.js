...
const router_1 = require("./scientificGames/v1/router");
const router_2 = require("./iGamer/router");
const app = new Koa();
...
app.use(respond())
    ...
    .use(bodyParser())
    .use(router.routes());
router.all('/v1/*', router_2.router.routes());
router.all('/sg-api/*', router_1.router.routes());
