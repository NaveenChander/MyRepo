...
class KnexLoadDal {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const promise = new Promise((resolve, reject) => {
                connectiondb('PatronWalletAccount')
                    .select('Balance', 'PatronWallet_ID', 'Limit', 'Account_ID')
                    .where({ Tenant_ID: tenantId, ExternalAccount_ID: externalpatronId })
                    .then((rows) => {
                    if (rows.length < 1) {
                        reject('Wallet Account not found');
                    }
                    if (amount > rows[0].Limit) {
                        reject('Exceded the limit');
                    }
                    const result = {
    ...
    loadWallet(tenantId, externalpatronId, propertyCode, transcationType, operatorTranscationId, amount, fundingType, walletContext) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
exports.KnexLoadDal = KnexLoadDal;
